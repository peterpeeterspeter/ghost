 ...
 */
export function buildStructuredPrompt(facts, controlBlock) {
    return {
        scene: {
 ...
 */
export function generateExpertAIPrompt(structured) {
 ...
 */
export function structuredPromptToText(structured) {
    const prompt = `
{
 ...
 */
export function generateHybridStructuredPrompt(facts, controlBlock, useExpertPrompt = false) {
 ...
 */
export function testStructuredPromptGeneration(facts, controlBlock) {
